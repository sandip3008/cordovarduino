...
public class UsbBroadcastReceiver extends BroadcastReceiver {
  ...
  public static final String USB_PERMISSION_with_data = "fr.drangies.cordova.serial.USB_PERMISSION_with_data";
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    } else if (USB_PERMISSION_with_data.equals(action)) {
      // deal with the user answer about the permission
      synchronized (this) {
...
//          Toast.makeText(context, "success to grant permission for device " + usbDevice.getDeviceId() + ", vendor_id: " + Integer.toString(usbDevice.getVendorId(), 16) + " product_id: " + Integer.toString(usbDevice.getProductId(), 16), Toast.LENGTH_LONG).show();
          ...
          try{
            ...
            PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, ret.toString());
